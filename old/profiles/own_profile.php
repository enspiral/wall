...
<div class="profile">
      ...
      <hr>
        ...
        <hr class="all-hr-project">
        <?php $project_follow = $Wall->Project_Follow_Count_Own($uid);
        ...
        if($project_follow){
               ...
               <?php }else{
                    echo "Project Following Not Found !";
                }
        ...
        <br/>
         ...
         <hr class="all-hr-project">
         <?php $follo_commnunity = $Wall->Community_Follow_Count_Own($uid);
                if($follo_commnunity){
        ...
        <?php $project_participation = $Wall->Participation_Group_Details($session_uid, '1'); 
           if($project_participation){
                ...
                <div><a href="<?php echo $base_url;?>cps_search.php" class="custom-file-input" original-title="Discower Needs!"><img src="images/profiles/btn_add.png"></a></div>
         <?php }else{
               echo "Project Participation Not Found !";
           }
