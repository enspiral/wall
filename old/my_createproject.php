...
<div id="div-whole" align="center">
    <h3 class="text-center text-pink">Create a Page for Your <b>Project ! </b></h3>
    ...
    <form method='post' action='' enctype="multipart/form-data">
        <table>
            <tr>
                ...
                <td><input type="text" name='proj_name' value="<?php echo $_POST['proj_name']; ?>" class="text-input" required="" placeholder="e.g. Project ABC"/>
                </td>
            ...
            <tr>
                <td valign='top' class="text-right"><label class="text-pink">*</label>What is the Community/Group were you working with?<br/>
                    <span class="smalltext">Can\'t find?<a><i class="text-primary add_new_com"> Register here!</i></a></span></td>
                <td>
                ...
                <td><label class="text-pink"><?php echo $error_info2; ?></label></td>
            </tr>
        </table>        
        <!-- Community -->
        <div class="div-new-community">
            ...
            <tr>
                <td valign='top' class="text-right">Are you part of the Organization?</td>
            ...
            <tr id="show_hide_org" <?php if($_POST['have_org']=="no") { ?> style="display: none;" <?php } ?>>
                <td valign='top' class="text-right">Your Organization<br/><span class="smalltext">Can't find? <i class="text-primary add_new_ngo">Register here!</i></span></td>
                <td>
            ...
            <div class="div-new-ngo">
                ...
                <table style="margin-left:110px;">
                    <tr>
                        ...
                        <td>volunteerbetter.com/pro/ <input type="text" name="proj_url" placeholder="careposit" value="<?php echo $_POST['proj_url']; ?>" style="width:193px;"/>
                        </td>
                        <td><label class="text-pink"><?php echo $error_info4; ?></label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="proj_lang" class="text-input languages" placeholder="eg. Chinese, English, Khmer..." value="<?php echo $_POST['proj_lang']; ?>"/> </td>
                        <td></td>
                    </tr>
                    <tr>
                        <td class="text-right">Skills required</td>
                        <td><input type="text" name="skills" class="text-input skills" placeholder="eg. Teaching/Painting/Constrcuting..." value="<?php echo $_POST['skills']; ?>"/> 
                        </td>
                        <td></td>
                    </tr>
                    <tr>
                        <td class="text-right">What is Your Role ?</td>
                        <td><input type="text" name="usr_role" class="text-input" placeholder="eg. Team Leader/Mentor/Guide/Teacher..." value="<?php echo $_POST['usr_role']; ?>"/>
                        </td>
                        <td></td>
                    </tr>
                </table>
