    ...
    <!-- start of -->
     ...
     <div class="block-right">
         <!-- <p class="text-right"><a href="" data-toggle="modal" data-target="#modal_contact"><i class="glyphicon glyphicon-edit"></i></a></p> -->
            ...
            <a href="" data-toggle="modal" data-target="#modal_contact"><i class="glyphicon glyphicon-edit custom-file-input eidt-all-icon" original-title="edit recruit_image" data-toggle="modal"></i></a>
...
<br/>
    <div style="background-color:#F5F5F5;"><p><?php echo $contact_decr; ?></p></div>
