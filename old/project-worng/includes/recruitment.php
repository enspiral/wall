...
<div class="block-right">    
     <a href="" data-toggle="modal" data-target="#recruit_image"><i class="glyphicon glyphicon-edit custom-file-input eidt-all-icon" original-title="edit recruit_image" data-toggle="modal" data-target="#modal_recruitment"></i></a>       
