...
{
$notification_url=$base_url.'groups/'.$n_msg_group_id;
}
else
{
$notification_url=$base_url.$n_msg_suid_username;
}
...
<?php if($n_message){ echo " status: ".$n_message; }?>
...
{
echo '<h4 id="noupdates">No Notifications Found</h4>';
}
?>
