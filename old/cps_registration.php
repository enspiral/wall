...
<body>
    <div class="header">
        ...
        <div class="col-lg-4"><button class="btn-primarybtn-block"><a href="<?php echo $base_url;?>">Login</button></a></div>
            </div>
    <div class="table-form registration" id="" align="center">
        <div class="bg-regester">
         <h3 class="text-center register-text">Registration as a CPS Member here</h3>

        <form method="post" action="" name="sign_up" id="sign_up">
            <div style="background-color:#FEF9FF; text-align: center;">
            <table>
                
                <tr>
                    <td class="text-right">Email: <label class="text-pink">*</label></td>
                    <td>
                        <input type="email" name="usr_first_name" id="usr_first_name" class="text-input form-control" value="<?php echo $_POST['usr_first_name'];?>" AUTOCOMPLETE='OFF'/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="tel" name="usr_phone" class="text-input form-control" value="<?php echo $_POST['usr_phone'];?>" AUTOCOMPLETE='OFF'/>
                ...
                <tr>
                    <td class="text-right"><div class="loginLabel">Residential Address:</div></td>
                    <td>
                        <input type="text" name="usr_add" class="input text-input form-control" value="<?php echo $_POST['usr_add'];?>" AUTOCOMPLETE='off' />
                    </td>
                    <td></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="text-right"><div class="loginLabel"> Enter the Code above here:<label class="text-pink">*</label> </div></td>
                    <td>
