        ...
        <div class="text social_need">
            <p class="text-title"><b>Social Needs</b>
                ...
                <?php if ($group_owner_id == $uid) {?>
                 ...
                 <span class="text-right"><a href="" data-toggle="modal" data-target="#edit_social_need"><i class="glyphicon glyphicon-edit custom-file-input" original-title="Edit Social Need"></i></a></span>
